"""
WSGI config for servicesDirectory project.
...
# os.environ["DJANGO_SETTINGS_MODULE"] = "servicesDirectory.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "servicesDirectory.settings")
